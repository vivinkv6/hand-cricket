...
function Selection() {
  const{setUser,setAi,list1,randomSelect,setUserIndex,setAiIndex,list2,userIndex,aiIndex,setUserScore,setAiScore,userScore,aiScore}= useContext(Data)
...
useEffect(() => {
  ...
  return (
    <div>
      <button className='btn btn-primary me-2 mt-2' onClick={()=>{
        ...
        <img src="https://img.icons8.com/ios/256/one-finger.png" height={30} width={30} alt="One" />
      </button>
      <button className='btn btn-primary me-2 mt-2' onClick={()=>{
      ...
      <img src="https://img.icons8.com/ios/256/two-fingers.png" height={30} width={30} alt="Two" />
      </button>
      ...
      <img src="https://img.icons8.com/ios/256/three-fingers.png" height={30} width={30} alt="Three" />
      </button>
      <button className='btn btn-primary me-2 mt-2' onClick={()=>{
      ...
      <img src="https://img.icons8.com/ios/256/four-fingers.png" height={30} width={30} alt="Four" />
      </button>
      <button className='btn btn-primary me-2 mt-2' onClick={()=>{
      ...
      <img src="https://img.icons8.com/ios/256/thumb-up.png" height={30} width={30} alt="Six" />
      </button>
    </div>
  )
}
